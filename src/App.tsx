                    ...
                    <table className="w-full border-collapse text-sm">
                        <thead>
                            <tr className="bg-gray-50/50 dark:bg-gray-800/50 border-b border-gray-100 dark:border-gray-800">
                                <th className="p-5 text-center font-bold text-gray-500 dark:text-gray-400 w-16 uppercase tracking-wider text-[10px]">ល.រ</th>
                                <th className="p-5 text-left font-bold text-gray-500 dark:text-gray-400 min-w-[450px] uppercase tracking-wider text-[10px]">ឈ្មោះសកម្មភាព</th>
                                <th className="p-5 text-center font-bold text-gray-500 dark:text-gray-400 w-40 uppercase tracking-wider text-[10px]">ស្ថានភាព</th>
                                <th className="p-5 text-center font-bold text-gray-500 dark:text-gray-400 w-32 uppercase tracking-wider text-[10px]">ថ្ងៃចាប់ផ្ដើម</th>
                                <th className="p-5 text-center font-bold text-gray-500 dark:text-gray-400 w-32 uppercase tracking-wider text-[10px]">ថ្ងៃផុតកំណត់</th>
                                <th className="p-5 text-left font-bold text-gray-500 dark:text-gray-400 w-48 uppercase tracking-wider text-[10px]">អ្នកទទួលខុសត្រូវ</th>
                                <th className="p-5 text-left font-bold text-gray-500 dark:text-gray-400 w-32 uppercase tracking-wider text-[10px]">ផ្សេងៗ</th>
                                {isEditor && <th className="p-5 text-center font-bold text-gray-500 dark:text-gray-400 w-24 sticky right-0 bg-gray-50/50 dark:bg-gray-800/50 uppercase tracking-wider text-[10px]">គ្រប់គ្រង</th>}
                            </tr>
                        </thead>
                        <tbody>
                            {filteredTasks.length === 0 ? (
                                <tr>
                                    <td colSpan={isEditor ? 8 : 7} className="p-24 text-center text-gray-400 dark:text-gray-600 italic">
                                ...
                                filteredTasks.map((task, idx) => (
                                    <tr key={task.id} className="border-b border-gray-50 dark:border-gray-800/50 hover:bg-brand-light/20 dark:hover:bg-brand-light/5 even:bg-gray-50/30 dark:even:bg-gray-800/20 transition-all group">
                                        <td className="p-5 text-center text-gray-400 dark:text-gray-500 font-mono font-bold text-xs">{idx + 1}</td>
                                        <td className="p-5 font-semibold text-gray-900 dark:text-gray-100 leading-relaxed whitespace-pre-wrap">{task.activity}</td>
                                        <td className="p-5">
                                        ...
                                        <td className="p-5 text-center text-gray-600 dark:text-gray-400 font-bold text-xs tracking-tight">{task.startDate}</td>
                                        <td className="p-5 text-center text-gray-600 dark:text-gray-400 font-bold text-xs tracking-tight">{task.deadline || <span className="opacity-20">-</span>}</td>
                                        <td className="p-5 text-gray-700 dark:text-gray-300 font-bold text-xs">{task.responsiblePerson || <span className="opacity-20">-</span>}</td>
                                        <td className="p-5 text-gray-500 dark:text-gray-500 italic text-[10px] leading-relaxed max-w-[120px] truncate" title={task.notes}>{task.notes || <span className="opacity-20">-</span>}</td>
                                        {isEditor && (
                                            <td className="p-5 sticky right-0 bg-inherit group-hover:bg-gray-50/80 dark:group-hover:bg-gray-800/80 transition-all">
